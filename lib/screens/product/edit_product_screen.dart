...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<SingleProductViewModel>(
        create: (_) => SingleProductViewModel(), child: EditProductBody());
  }
}
    ...
    try {
      ...
      if (product != null) {
        ...
        _productPriceController.text =
            product.productPrice == null ? "" : product.productPrice.toString();
  ...
  Widget build(BuildContext context) {
    return Consumer<SingleProductViewModel>(
      ...
      return Scaffold(
        ...
        body:
            Consumer<CategoryViewModel>(builder: (context, categoryVM, child) {
          return SafeArea(
